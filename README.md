...
- [Arcane Quest Chat Room](https://github.com/Ethereum-Jakarta/phase-1-week5-backend-advance/blob/main/arcane_quest/ln-ws-chat.md)
...
- [LN (Microservices + bun stacks , payment gateway stripe)](https://github.com/Ethereum-Jakarta/phase-1-week5-backend-advance/blob/main/arcane_quest/ln-microservice.md)
- [Group Project Nolep (Phase 1) :exploding_head: :exploding_head: :exploding_head: ](https://github.com/Ethereum-Jakarta/phase-1-week5-backend-advance/blob/main/arcane_quest/gpn-phase1.md)
